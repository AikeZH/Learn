...
public class StringSorting {
    public static void main(String[] args) {
        // TODO
        String[] sa = {new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next(), new RandomGenerator.String(5).next()};
